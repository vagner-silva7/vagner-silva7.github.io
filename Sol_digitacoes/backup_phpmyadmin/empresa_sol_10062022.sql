...
--
-- Host: 127.0.0.1
-- Tempo de geração: 10-Jun-2022 às 05:21
...
INSERT INTO `fabricantes` (`id`, `nome`, `usuarios_id`) VALUES
(1, 'asus', 1),
...
INSERT INTO `posts` (`id`, `data`, `titulo`, `texto`, `resumo`, `imagem`, `usuarios_id`) VALUES
...
(12, '2022-06-08 13:18:09', 'teste 1 atualizado', 'teste 1 atualizado', 'teste 1 atualizado', 'abstrato.jpg', 1),
...
CREATE TABLE `produtos` (
  ...
  `fabricantes_id` int(11) DEFAULT NULL,
  `usuarios_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `produtos` (`id`, `nome`, `preco`, `quantidade`, `descricao`, `fabricantes_id`, `usuarios_id`) VALUES
