...
--
-- Host: 127.0.0.1
-- Tempo de geração: 22-Jun-2022 às 05:15
...
(2, 'microsoft do brasil', 3),
(3, 'Brastemp do brasil', 1),
(4, 'dell do brasil', 3),
(5, 'sony do brasil', 1),
(7, 'hp do brasil', 1);
...
INSERT INTO `produtos` (`id`, `nome`, `preco`, `quantidade`, `descricao`, `fabricante_id`, `usuario_id`) VALUES
(1, 'Computador g50gggg', '9500.00', 7, '   Memória ram 16gb - com DVD - Modelo 5G  ', 7, 1),
(2, 'Fogão 6 bocas a', '5000.00', 7, ' 6 bocas em vidro ', 3, 3);
...
ALTER TABLE `fabricantes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_fabricantes_usuarios1` (`usuario_id`);
...
ALTER TABLE `produtos`
  ...
  ADD KEY `fk_produtos_usuarios1` (`usuario_id`);
...
--
ALTER TABLE `fabricantes`
  ADD CONSTRAINT `fk_fabricantes_usuarios1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`);
